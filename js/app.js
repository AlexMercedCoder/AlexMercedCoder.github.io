...
const domVals = {
    ...
    <p> My name is Alex Merced and I'm a Web Developer who brings a creative and curious outlook to the table along with experience in education, finance, broadcast, retail and politics to contribute unique ideas and perspectives.</p>
    <p>In broadcasting, finance and politics I've been known as an effective educator and communicator whether speaking/training in front of voters, candidates, new hires and managing directors. As a web developer I hope to also be a quality educator, communicator and a top-tier creator using my ability to learn, adapt and deliver effectively.</p>
